...
const dict = {
  zh: {
    heroTitle: "量子安全代理中转站",
    heroDesc: "完全内嵌的高速隐私代理架构，提供绝对隐私保护与深度 API 路由分流。",
    feature1Title: "流量深度混淆",
    feature1Desc: "响应数据动态填充随机字节，突破运营商 DPI (深度包检测) 特征识别，绝对隐藏您的访问内容。",
    feature2Title: "无痕中转隧道",
    feature2Desc: "您的网络提供商只能看到与服务端的 TLS 加密连接。目标网站 100% 隐藏，强制剥离所有追踪请求头。",
  ...
  en: {
    ...
    heroDesc: "Fully embedded high-speed privacy proxy architecture for absolute privacy and deep API routing.",
    ...
    feature2Desc: "Your ISP only sees an encrypted TLS connection to our server. Target domains remain 100% hidden. Tracking headers stripped.",
